...
function makeList(data) {
  ...
  apts.forEach((apt) => {
    ...
    floorTd.appendChild(document.createTextNode(apt["층"]));
    tr.appendChild(floorTd);

    let areaTd = document.createElement("td");
    areaTd.appendChild(document.createTextNode(apt["전용면적"]));
    tr.appendChild(areaTd);

    let dongTd = document.createElement("td");
    dongTd.appendChild(document.createTextNode(apt["법정동"]));
...
function parsing(data) {
  ...
  let apts = obj.response.body.items.item;
