...
import com.ssafy.pjt.qna.model.service.CommentService;
...
public class CommentRestController {
	...
	@GetMapping("/{qnaNo}")
	public ResponseEntity<?> listComment(@PathVariable("qnaNo") int qnaNo) {
		logger.debug("listComment - 호출");

		try {
			List<Comment> listComment = commentService.list(qnaNo);
