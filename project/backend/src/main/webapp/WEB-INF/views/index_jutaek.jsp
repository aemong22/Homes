...
<html lang="en">
  ...
  <body>
      ...
      <div class="pagetitle">
        ...
        <nav>
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">연립다세대</li>
          </ol>
        </nav>
            ...
            <div class="row">
              ...
              <div class="col-12">
                <div class="card">
                  ...
                  <div class="card-body">
                    <h5 class="card-title"><b>연립다세대 실거래가 조회</b> <span>| 업데이트 2022-09-07</span></h5>
   ...
   document.querySelector("#list-btn").addEventListener("click", function () {
     ...
     //let url =  "http://openapi.molit.go.kr:8081/OpenAPI_ToolInstallPackage/service/rest/RTMSOBJSvc/getRTMSDataSvcRHTrade";
     ...
     let url = '${root}/houseInfo/jutaek?code='+regCode+'&dealYM='+dealYM;
     fetch(url, {
    	 method: 'GET'
     })
       .then((response) => response.text())
       .then((data) => {map_marker(data);
   ...
   function initTable() {
	...
	<script src="${root}/assets/js/jutaek_map.js"></script>
