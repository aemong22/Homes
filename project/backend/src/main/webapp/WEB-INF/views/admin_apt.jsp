...
<body>
	...
	<div class="pagetitle">
		...
		<nav>
			<ol class="breadcrumb">
				<li class="breadcrumb-item"><a href="${root}/index.jsp">관리자</a></li>
				<li class="breadcrumb-item active">아파트 정보 관리</li>
			</ol>
		</nav>
...
<script src="${root}/assets/js/admin_map.js"></script>
